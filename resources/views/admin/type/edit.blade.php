    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Type ✨</h1>
            </div>
        ...
        <div class="flex sm:flex-row md:flex-col items-center">
            <div class="grow w-2/3 content-center bg-white shadow-lg rounded-sm border border-slate-200">
                <header class="flex flex-row px-5 py-4 border-b border-slate-100 justify-between">
                    <h2 class="font-semibold text-slate-800">Edit Type</h2>
                ...
                <div class="p-3">
                    ...
                    <div class="flex flex-wrap">
                        <form action="{{ route('admin.type.update', $type->id) }}" method="post" class="w-full mx-auto">
                            @csrf
                            @method('put')
                            <div class="mb-5">
                                ...
                                <input value="{{ old('name') ?? $type->name }}" name="name" type="text" placeholder="Nama Type"
