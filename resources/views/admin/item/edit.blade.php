    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Item ✨</h1>
            </div>
        ...
        <div class="flex sm:flex-row md:flex-col items-center">
            <div class="grow w-full content-center bg-white shadow-lg rounded-sm border border-slate-200">
                <header class="flex flex-row px-5 py-4 border-b border-slate-100 justify-between">
                    <h2 class="font-semibold text-slate-800">Edit Item - {{ $item->name }}</h2>
                ...
                <div class="p-3">
                    ...
                    <div class="flex flex-wrap">
                        <form action="{{ route('admin.item.update', $item->id) }}" method="POST" class="w-full mx-auto"
                            ...
                            <div class="mb-5">
                                ...
                                <input value="{{ old('name') ?? $item->name }}" name="name" type="text" placeholder="Nama Item"
                            ...
                            <div class="grid grid-cols md:grid-cols-2 md:gap-4">
                                <div class="mb-5 w-full">
                                    ...
                                    <input value="{{ old('price') ?? $item->price }}" name="price" type="number"
                                ...
                                <div class="mb-5 w-full">
                                    ...
                                    <input value="{{ old('features') ?? $item->features }}" name="features" type="text"
                            ...
                            <div class="grid grid-cols md:grid-cols-2 md:gap-4">
                                <div class="mb-5 w-full">
                                    ...
                                    <input value="{{ old('star') ?? $item->star }}" name="star" type="number"
                                           class="form-input w-full focus:border-blue-500"
                                ...
                                <div class="mb-5 w-full">
                                    ...
                                    <input value="{{ old('review') ?? $item->review }}" name="review" type="text"
                                           class="form-input w-full focus:border-blue-500"
                            ...
                            <div class="bg-white p7 rounded w-9/12 mx-auto">
                                <div x-data="dataFileDnD()"
                                    ...
                                    <div x-ref="dnd"
                                        ...
                                        <div class="flex flex-col item-center justify-center py-10 text-center">
                                    ...
                                    <template x-if="files.length > 0">
                                        <div class="grid grid-cols-2 gap-4 mt-4 md:grid-cols-6"
                                            ...
                                            <template x-for="(_, index) in Array.from({ length: files.length })">
                                                <div
                                                    class="relative flex flex-col item-center overflow-hidden text-center bg-gray-100 border rounded cursor-move select-none"
