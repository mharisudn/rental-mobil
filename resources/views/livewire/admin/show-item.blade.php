            ...
            <header class="block justify-between items-center sm:flex py-6 px-4">
                ...
                <div class="mt-3 sm:mt-0 flex space-x-2 sm:justify-between justify-end">
                    ...
                    @if(!$selected)
                        ...
                        <!-- Add button -->
                        <a item="button" href="{{ route('admin.item.create') }}"
                ...
                <table class="table-auto w-full">
                    ...
                    @forelse($item as $key => $item)
                        <tr wire:key="row{{ $item->id }}">
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 shrink-0 mr-2 sm:mr-3">
                                        <img class="rounded-full" src="{{ $item->thumbnail }}" width="40" height="40" />
                                    </div>
                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">{{ $item->price }}</td>
