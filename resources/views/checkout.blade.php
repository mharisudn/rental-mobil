            ...
            <div class="flex items-center gap-5 lg:justify-between">
                ...
                <form action=""
                    ...
                    <div class="grid grid-cols-2 items-center gap-y-6 gap-x-4 lg:gap-x-[30px]">
                        ...
                        @livewire('front.list-region', [
                        'province_id' => old('province_code', $item->province_code),
                        'city_id' => old('city_code', $item->city_code),
                        'district_id' => old('district_code', $item->district_code),
                        'village_id' => old('village_code', $item->village_code),
                        ])
